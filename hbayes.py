...
def r(l00,l10,l20,l01,l11,l21):
    # print('h')
    g00 = gamma.pdf(l00,m_1 + m_2, 0, 1/(Delta(alpha)))
    g10 = gamma.pdf(l10,m_1, 0, 1/(Delta(alpha)))
    g20 = gamma.pdf(l20,m_2, 0, 1/(Delta(alpha)))
    g01 = gamma.pdf(l01,m_1 + m_2 , 0, 1/(Delta(alpha)))
    g11 = gamma.pdf(l11,m_1, 0, 1/(Delta(alpha)))
    g21 = gamma.pdf(l21,m_2, 0, 1/(Delta(alpha)))
...
while(i<N):
    ...
    # print(R)
    R = min(1, r(l_0[i], l_1[i], l_2[i], lo_0, lo_1, lo_2))
